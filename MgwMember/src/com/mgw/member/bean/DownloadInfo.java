...
import com.mgw.member.manager.DownloadManager;
...
public class DownloadInfo {
	...
	private long htmlSize = 0;//html增量的size
	private int htmlCount=0;	//html的文件的个数
	...
	public static DownloadInfo clone(AppInfo info) {
		...
		downloadInfo.htmlSize = info.getSize();
