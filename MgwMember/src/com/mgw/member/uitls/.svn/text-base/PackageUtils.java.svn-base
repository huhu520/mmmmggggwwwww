...
/**
 * Created by huyan on 2014/6/19.
 * 包工具类
 */
public class PackageUtils {

	/** 获取版本信息的网络请求方法 */
	public static String sendPost(List<NameValuePair> params) {

		HttpPost httpPost = new HttpPost(Define_C.mgw_url);
		LogUtils.e("httpPost=" + httpPost);
		HttpResponse httpResponse = null;
		try {
			httpPost.setEntity(new UrlEncodedFormEntity(params, HTTP.UTF_8));
//			LogUtils.e("httpPost:" +httpPost.get);
	...
	public static String getVersionName() {
		try {
			PackageInfo pInfo = getPackageInfo(null);
