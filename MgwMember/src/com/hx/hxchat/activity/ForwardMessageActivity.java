...
public class ForwardMessageActivity extends PickContactNoCheckboxActivity {
	...
	private String forward_msg_nick;
...
//		if (position != 0) {
			...
			User contact = BaseApplication.getApplication().GetUserDao().getContact(selectUser.getUsername());
			intent.putExtra("msg", getString(R.string.confirm_forward_to, contact.getNick()));
