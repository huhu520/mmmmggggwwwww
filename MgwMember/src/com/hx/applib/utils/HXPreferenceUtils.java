/**
1 * Copyright (C) 2013-2014 EaseMob Technologies. All rights reserved.
 *
...
public class HXPreferenceUtils {
	...
	private String SHARED_KEY_SETTING_NOTIFICATION_SHARE = "shared_key_setting_notification_share";
	...
	//====通知栏设置开关====start
	public void setSettingNotification(boolean paramBoolean) {
		editor.putBoolean(SHARED_KEY_SETTING_NOTIFICATION_SHARE, paramBoolean);
		editor.commit();
	}
	
	public boolean getSettingNotification() {
		return mSharedPreferences.getBoolean(SHARED_KEY_SETTING_NOTIFICATION_SHARE, true);
	}
	//====通知栏设置开关====end
}
